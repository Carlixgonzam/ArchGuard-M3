...
1.  **Analyzer (Rascal)**: Parses the source code to construct a comprehensive relationship model.
2.  **Oracle (DSL)**: Defines the architectural "ground truth" through compliance rules.
3.  **Comparator**: Executes relational algebra within Rascal to determine the delta between implementation and design.
